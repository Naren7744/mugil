...
const Features = () => {
  ...
  data-aos-delay="100" className="flex flex-col mb-16 border-l-2 border-[#ffc114] pl-4 justify-start items-start">
  ...
  data-aos-delay={idx * 150 + 150} className="w-14 h-14 rounded-xl bg-zinc-900/50 border border-zinc-800/40 flex items-center justify-center text-[#ffc114] text-2xl mb-6 group-hover:bg-[#ffc114] group-hover:text-black group-hover:border-[#ffc114] transition-all duration-500 shadow-lg shadow-black/50">
                  {item.icon}
                </div>
                
                <h4   data-aos="fade-up"
  data-aos-delay={idx * 150 + 250} className="text-white font-bold text-[13px] tracking-[0.15em] uppercase mb-3 group-hover:text-[#ffc114] transition-colors duration-300">
                  {item.title}
                </h4>
              </div>
              ...
              <div className="relative z-10 mt-2 text-start">
                <p   data-aos="fade-up"
  data-aos-delay={idx * 150 + 350} className="text-zinc-500 text-[12px] font-medium tracking-wide leading-relaxed group-hover:text-zinc-400 transition-colors duration-300 max-w-[95%]">
                  {item.desc}
                </p>
              </div>
