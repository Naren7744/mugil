...
const Branches = () => {
  const branchData = [
    ...
    },
    {
      ...
      location: "Government Engineering College Opposite, Karupur, Omalur Tk, Salem Dt - 636011",
      timings: [
        "Mon - Sat: 05:00 AM - 10:00 AM",
        "Mon - Sat: 04:00 PM - 10:00 PM",
        "Sunday: Morning Session Only"
  ...
  data-aos-delay="100" className="flex flex-col items-start space-y-4 mb-20 border-l-2 border-[#ffc114] pl-4 justify-start">
  ...
  data-aos-delay="150" className="mb-10 flex flex-col items-start">
                  <span className="text-zinc-700 font-mono text-[11px] block mb-2">// BRANCH 0{branch.id}</span>
                ...
                <div className="space-y-6 text-zinc-400 text-[11px] font-medium tracking-wider uppercase flex flex-col items-start">
                  ...
                  <div  data-aos="fade-up"
  data-aos-delay="250" className="flex items-start gap-4 text-start">
                    <FiMapPin className="text-[#ffc114] text-base shrink-0 mt-0.5 transition-colors duration-500" />
                    <div className="flex flex-col space-y-1 items-start">
                      <span className="text-zinc-600 font-bold tracking-widest text-[8.5px]">ADDRESS</span>
                  ...
                  <div  data-aos="fade-up"
  data-aos-delay="350" className="flex items-start gap-4 text-start">
                    <FiClock className="text-[#ffc114] text-base shrink-0 mt-0.5 transition-colors duration-500" />
                    <div className="flex flex-col space-y-1 items-start">
                      <span className="text-zinc-600 font-bold tracking-widest text-[8.5px]">TIMINGS</span>
                  ...
                  <div   data-aos="fade-up"
  data-aos-delay="450" className="flex items-start gap-4 text-start">
                    <FiPhone className="text-[#ffc114] text-base shrink-0 transition-colors duration-500" />
                    <div className="flex flex-col space-y-1 items-start">
                      <span className="text-zinc-600 font-bold tracking-widest text-[8.5px]">CONTACT</span>
                      <span className="text-white group-hover:text-[#ffc114] font-black tracking-[0.1em] text-xs transition-colors duration-500">{branch.phone}</span>
                    </div>
                  </div>
  ...
  data-aos-delay="550" className="mt-12 pt-4 border-t border-white/[0.02] w-full text-start flex justify-start">
                <a 
                  href={branch.mapUrl}
                  target="_blank"
