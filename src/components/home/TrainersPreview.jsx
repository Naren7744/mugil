...
const TrainersPreview = () => {
  ...
  data-aos-delay="100" className="flex flex-col md:flex-row md:items-end justify-between border-b border-white/[0.04] pb-10 mb-16 lg:mb-20 gap-6 w-full text-start">
          ...
          <p className="text-zinc-500 text-xs font-light tracking-widest uppercase max-w-xs md:text-right leading-relaxed">
            Certified elite mechanic redefining strength limits and human physiology.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center w-full">
          ...
          <div   data-aos="fade-right"
  data-aos-duration="1000" className="lg:col-span-5 w-full flex justify-center">
            <div className="bg-[#070707] border border-white/[0.04] rounded-none overflow-hidden relative group w-full max-w-[420px] h-[480px] sm:h-[540px] transition-all duration-700 ease-out hover:border-[#ffc114]/30 shadow-2xl flex flex-col justify-end items-start">
              ...
              <div className="absolute top-6 left-6 z-10 flex flex-col gap-3 opacity-60 group-hover:opacity-100 transition-opacity duration-500">
                <a href="#" className="w-8 h-8 bg-[#030303]/80 border border-white/10 text-white hover:text-black hover:bg-[#ffc114] hover:border-[#ffc114] flex items-center justify-center transition-all duration-300 backdrop-blur-md">
              ...
              <div className="relative z-10 p-8 w-full bg-gradient-to-t from-[#030303] via-[#030303]/80 to-transparent pt-20 text-start">
                <span className="text-zinc-600 font-mono text-[10px] block mb-1">// MAIN ANCHOR</span>
                <h4 className="text-[14px] font-bold tracking-[0.2em] text-[#ffc114] uppercase">MUGIL FITNESS EXECUTIVE</h4>
              </div>
  ...
  data-aos-delay="200" className="lg:col-span-7 flex flex-col items-start space-y-8 text-start">
            
            <div   data-aos="fade-up"
  data-aos-delay="300" className="space-y-3">
              <span className="text-zinc-600 font-mono text-[11px] block tracking-widest">// BIO-MECHANICS DIRECTOR</span>
            ...
            <p   data-aos="fade-up"
  data-aos-delay="400" className="text-zinc-400 text-[13px] font-light tracking-wide leading-relaxed uppercase max-w-xl">
              {trainerData.bio}
            </p>

            <div   data-aos="fade-up"
  data-aos-delay="500" className="w-full pt-4">
              <span className="text-zinc-600 font-mono text-[9px] block tracking-[0.25em] mb-4 uppercase">// VERIFIED ARCHITECTURE CAPABILITIES</span>
